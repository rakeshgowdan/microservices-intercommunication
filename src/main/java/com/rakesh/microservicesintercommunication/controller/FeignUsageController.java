...
import com.rakesh.microservicesintercommunication.service.FeignClientConsumer;

@RestController
@RequestMapping("/api/feign/users")
public class FeignUsageController {

	@Autowired
	private FeignClientConsumer consumer;
	
	@GetMapping("/getDataByFeign")
	public Users getUser() {
		return consumer.getUserByFeign();
